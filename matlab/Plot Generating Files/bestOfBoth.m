...
x = [939 964 965 967 975 985 988 1007];
y = ['Mixed Preclocking' 'Correlation' 'Goertzel' 'AGWPE' 'Top 3 in Parallel' 'Kam Plus (2)' 'Kam' 'PK-88 (2)'];
f = figure('Position',[0,0,1280,1024]);
set(gcf,'color','w');
bar(x);
filename = 'Best Software versus Best Hardware';
title(filename);
%xlabel('Devices');
ylabel('Number of Packets Decoded');
set(gca,'XTickLabel',{'Mixed Preclocking' 'Correlation' 'Goertzel' 'AGWPE' 'Top 3 in Parallel' 'Kam Plus (2)' 'Kam' 'PK-88 (2)'})
